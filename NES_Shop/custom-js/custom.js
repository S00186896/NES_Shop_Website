  $(document).ready(function(){
    ...
    $("#totalCost" ).html(localStorage.getItem('totalCost'));
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="arcadia@email.com" && password=="password")  {   
    ...
    if (localStorage.getItem('userdetails') === null) {  
        ...
        var userDetails = {firstName:"Art", lastName:"Mc Goldrick", dob:"1990-12-01",address1:"Snugborough", address2:"Ballyconnell", address3:"Co. Cavan"};
    ...
    $(".addtocart").click(function(){
        ...
        var totalNum = Number(localStorage.getItem('totalCost'));
        totalNum = 20 + totalNum;
        localStorage.setItem('totalCost',totalNum);
    });
